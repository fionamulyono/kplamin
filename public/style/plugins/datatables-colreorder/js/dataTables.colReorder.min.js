...
(function (e) {
    ...
    e.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, f, g) {
        ...
        if (b != d)
            ...
            if (null !== a.aaSortingFixed) {
                c = 0;
                for (h = a.aaSortingFixed.length; c < h; c++) a.aaSortingFixed[c][0] = m[a.aaSortingFixed[c][0]]
            }
            c = 0;
            for (h = i; c < h; c++) {
                k = a.aoColumns[c];
            ...
            if (null !== a.aoFooter) {
                c = 0;
                for (h = a.aoFooter.length; c < h; c++) q(a.aoFooter[c], b, d)
    ...
    e.extend(i.prototype, {
        ...
        fnOrder: function (a, b) {
            var d = [],
                f, g, c = this.s.dt.aoColumns;
            if (a === s) {
                f = 0;
                for (g = c.length; f < g; f++) d.push(c[f]._ColReorder_iOrigCol);
                return d
            }
            if (b) {
                c = this.fnOrder();
        ...
        fnTranspose: function (a, b) {
            ...
            return "toCurrent" === b ? !e.isArray(a) ? e.inArray(a, d) : e.map(a, function (a) {
        ...
        _fnStateSave: function (a) {
            ...
            if (a.aaSorting) {
                ...
                b = 0;
                for (d = g.length; b < d; b++) f = g[b]._ColReorder_iOrigCol, a.columns[f] = c[b], a.ColReorder.push(f)
            }
        },
        ...
        _fnMouseDown: function (a, b) {
            ...
            g !== s && (this.s.mouse.startX = this._fnCursorPosition(a, "pageX"), this.s.mouse.startY = this._fnCursorPosition(a, "pageY"), this.s.mouse.offsetX = this._fnCursorPosition(a, "pageX") - f.left, this.s.mouse.offsetY =
                this._fnCursorPosition(a, "pageY") - f.top, this.s.mouse.target = this.s.dt.aoColumns[g].nTh, this.s.mouse.targetIndex = g, this.s.mouse.fromIndex = g, this._fnRegions(), e(o).on("mousemove.ColReorder touchmove.ColReorder", function (a) {
        ...
        _fnMouseMove: function (a) {
            ...
            for (var d, e = this.s.mouse.toIndex, a = this._fnCursorPosition(a, "pageX"), g = function () {
        ...
        _fnCreateDragNode: function () {
            var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY,
                ...
                g = f.parentNode,
                c = e(b).clone();
            this.dom.drag = e(g.cloneNode(!1)).addClass("DTCR_clonedTable").append(e(f.cloneNode(!1)).append(e(d.cloneNode(!1)).append(c[0]))).css({
                position: "absolute",
                top: 0,
                left: 0,
